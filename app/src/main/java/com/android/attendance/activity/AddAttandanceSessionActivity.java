...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] { "MCA","MBA","B.TECH","M.TECH"};
	...
	private String[] subjectFinal = new String[] {"Python","Java","C++","Networks","Database","DataStructure"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		spinneryear.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			/*	if(yearString.equals("1st Year"))
				{
					subjectFinal = subjectSEString;
				}
				else if(yearString.equals("2nd Year"))
				{
					subjectFinal = subjectTEString;
				}
				else if(yearString.equals("3rd Year"))
				{
